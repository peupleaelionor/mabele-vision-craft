...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden">
      <div className="container-edge pt-16 sm:pt-24 pb-10 sm:pb-16 text-center">
        ...
        <h1 className="mt-7 sm:mt-10 font-serif text-5xl sm:text-7xl md:text-8xl leading-[0.95] tracking-tight text-balance">
          ...
          <span className="block text-primary italic font-medium">Construire plus fort.</span>
        </h1>
      ...
      <div className="container-edge pb-0">
        <div className="relative overflow-hidden rounded-[28px] sm:rounded-[40px] shadow-elevated">
          <img
            ...
            width={1920}
            height={1080}
            className="w-full h-[50vh] sm:h-[68vh] object-cover"
          />
